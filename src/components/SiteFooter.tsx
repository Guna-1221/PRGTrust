          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs uppercase tracking-widest text-white/70">
                Anantapur · Reg. No. 25/2026
              </div>
            </div>
          </div>
          <p className="mt-4 max-w-md text-sm text-white/80">
            A registered public charitable trust working for education, healthcare, women
            empowerment, environment, and community welfare across Andhra Pradesh.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-white/80">
            <li className="flex gap-2">
              <MapPin size={16} className="mt-0.5 text-brand-orange shrink-0" />
              3-14, Madigubba, Athmakur Mandal, Anantapur District, Andhra Pradesh
            </li>
            <li className="flex gap-2">
              <Phone size={16} className="text-brand-orange" />
              <a href="tel:+919951217286" className="hover:text-white">
                +91 99512 17286
              </a>
            </li>
            <li className="flex gap-2">
              <Mail size={16} className="text-brand-orange" />
              <a href="mailto:info@prgtrust.org" className="hover:text-white">
                info@prgtrust.org
              </a>
            </li>
          </ul>
