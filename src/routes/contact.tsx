  ...
  head: () => ({
    meta: [
      { title: "Contact — PRG Social Welfare Trust" },
      {
        name: "description",
        content:
          "Get in touch with PRG Social Welfare Trust, Anantapur. Phone, email, address and contact form.",
      },
          ...
          <div className="md:col-span-2 space-y-5">
            ...
            <div className="card-soft p-6 flex gap-4">
              ...
              <div>
                ...
                <a
                  href="tel:+919951217286"
                  className="mt-1 block text-sm text-foreground/85 hover:text-brand-blue"
                >
                  +91 99512 17286
                </a>
              </div>
