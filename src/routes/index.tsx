  ...
  head: () => ({
    meta: [
      { title: "PRG Social Welfare Trust — Together for Change" },
      {
        name: "description",
        content:
          "Empowering underprivileged communities in Anantapur through education, healthcare, women empowerment, and environmental sustainability.",
      },
      { property: "og:title", content: "PRG Social Welfare Trust — Together for Change" },
      {
        property: "og:description",
        content: "Join us in building an inclusive, empowered, and sustainable society.",
      },
    ],
  }),
  component: HomePage,
...
const programs = [
  {
    ...
    desc: "Scholarships, school supplies and learning support for underprivileged children.",
  ...
  },
  {
    ...
    desc: "Free medical camps, health awareness and access to essential care.",
  ...
  },
  {
    ...
    desc: "Skill training, livelihood programs and self-reliance initiatives.",
  ...
  },
  {
    ...
    desc: "Food relief, senior citizen care, disaster response and inclusion.",
    color: "text-brand-orange-deep",
    bg: "bg-brand-orange/15",
  },
  {
    ...
    desc: "Tree plantation drives and community-led sustainability projects.",
...
function HomePage() {
  ...
  return (
    <>
        ...
        <div className="container-x relative grid gap-10 py-20 md:grid-cols-12 md:py-28">
          <div className="md:col-span-7 text-white">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 text-xs font-medium uppercase tracking-widest text-white/90 backdrop-blur">
              <span className="h-1.5 w-1.5 rounded-full bg-brand-orange" /> Registered Public
              Charitable Trust · Reg 25/2026
            </span>
            ...
            <p className="mt-5 max-w-xl text-base text-white/85 sm:text-lg">
              ...
              uplifting children, women, and the environment through sustainable, transparent
              action.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                to="/programs"
                className="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold btn-outline-light"
              >
                Our Programs
              </Link>
            </div>
          ...
          <div className="md:col-span-5">
            <div className="relative mx-auto max-w-sm">
              <div
                className="absolute -inset-4 rounded-3xl bg-brand-orange/30 blur-2xl"
                aria-hidden
              />
              <img
                src={hero}
      ...
      {events.length > 0 && (
        <section className="bg-brand-orange/10 border-b border-brand-orange/20">
          <div className="container-x py-10 md:py-14">
            <div className="flex items-center gap-3">
              <CalendarDays className="text-brand-orange-deep" size={26} />
              <h2 className="text-2xl md:text-3xl">Events at PRG Trust</h2>
            </div>
            <div className="mt-6 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {events.map((e) => (
                <article key={e.id} className="card-soft overflow-hidden flex flex-col bg-card">
                  {e.image && (
                  ...
                  <div className="p-5 flex-1">
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-foreground/60">
                      <span className="inline-flex items-center gap-1.5">
                        <CalendarDays size={14} /> {e.eventDate}
                      </span>
                      {e.location && (
                        <span className="inline-flex items-center gap-1.5">
      ...
      <section className="section-pad">
        <div className="container-x grid gap-10 md:grid-cols-12 items-center">
          ...
          <p className="md:col-span-7 text-lg leading-relaxed text-foreground/80">
            ...
            community welfare — supporting underprivileged groups, creating livelihood
            opportunities, and implementing sustainable development through collaboration and
            transparency.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-foreground/70 max-w-xl">
                Five focus areas, one shared goal — dignity and opportunity for all.
              </p>
            </div>
            <Link
              to="/programs"
              className="text-sm font-semibold text-brand-blue inline-flex items-center gap-1 hover:gap-2 transition-all"
            >
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
            {programs.map((p) => (
              <article key={p.title} className="card-soft p-6">
                <div
                  className={`inline-flex h-12 w-12 items-center justify-center rounded-xl ${p.bg} ${p.color}`}
                >
                  <p.icon size={24} />
                </div>
            ...
            {(donations.length > 0
              ...
              : [
                  ...
                  },
                  {
                    ...
                    description:
                      "Volunteer handing a food packet to an elderly woman in a red saree.",
                  },
                ]
            ).map((item) => (
              <figure key={item.id} className="card-soft overflow-hidden group flex flex-col">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-brand-blue-deep text-white p-8 md:p-14">
            ...
            <div className="relative max-w-3xl">
              ...
              <p className="mt-6 text-white/85 leading-relaxed">
                ...
                lasting impact. I invite individuals, donors and organisations to join hands with us
                in this journey of service.”
              </p>
              <div className="mt-6">
                <div className="font-display text-lg font-semibold text-brand-orange">
                  Mr. Y. Ramanjaneyulu
                </div>
        ...
        <div className="container-x">
          <div className="rounded-3xl border border-border bg-card p-8 md:p-12 text-center md:text-left md:flex md:items-center md:justify-between gap-8 shadow-soft">
            <div>
              ...
              <p className="mt-2 text-foreground/70 max-w-xl">
                Volunteer your time or partner with us to scale impact in rural Andhra Pradesh.
              </p>
            </div>
            <div className="mt-6 md:mt-0 flex flex-wrap justify-center gap-3">
              <Link
                to="/get-involved"
                className="inline-flex items-center rounded-full px-6 py-3 text-sm font-semibold btn-primary"
              >
                Get Involved
              </Link>
              <Link
                to="/contact"
                className="inline-flex items-center rounded-full px-6 py-3 text-sm font-semibold border border-brand-blue text-brand-blue hover:bg-brand-blue hover:text-white transition-colors"
              >
                Contact us
              </Link>
            </div>
