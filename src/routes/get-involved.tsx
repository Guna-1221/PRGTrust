  ...
  head: () => ({
    meta: [
      { title: "Get Involved — PRG Social Welfare Trust" },
      {
        name: "description",
        content:
          "Volunteer or partner with PRG Social Welfare Trust to support communities in Anantapur.",
      },
...
const ways = [
  {
    icon: Users,
    title: "Volunteer",
    desc: "Lend your time and skills — teach, organise camps, or join plantation drives.",
    cta: "Join us",
    to: "/contact" as const,
  },
  {
    icon: Building2,
    title: "Partner",
    desc: "Corporates and NGOs — collaborate on CSR programs with measurable impact.",
  ...
  },
  {
    ...
    desc: "Share our mission with your network and help us reach more communities.",
    cta: "Get in touch",
    to: "/contact" as const,
  },
];
  ...
  return (
    <>
      <section className="relative bg-brand-blue-deep text-white overflow-hidden">
        <div
          className="absolute -top-20 -right-20 h-80 w-80 rounded-full bg-brand-orange/20 blur-3xl"
          aria-hidden
        />
        ...
        <div className="container-x grid gap-6 md:grid-cols-3">
          {ways.map((w) => (
            <article key={w.title} className="card-soft p-7 flex flex-col">
              ...
              <Link
                to={w.to}
                className="mt-5 inline-flex items-center text-sm font-semibold text-brand-blue hover:underline"
              >
                {w.cta} →
              </Link>
            </article>
          ...
          <div className="card-soft p-8">
            ...
            <ul className="mt-5 space-y-3 text-sm">
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+919951217286" className="hover:underline">
                  +91 99512 17286
                </a>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@prgtrust.org" className="hover:underline">
                  info@prgtrust.org
                </a>
              </li>
            </ul>
            <Link
              to="/contact"
              className="mt-6 inline-flex items-center rounded-full px-5 py-2.5 text-sm font-semibold btn-primary"
            >
              Contact form
            </Link>
          </div>
